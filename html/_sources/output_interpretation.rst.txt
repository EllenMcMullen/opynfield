...
Results Folder
==============
A folder will now exist at the path you provided as the ``result_path`` attribute in your ``User Input`` argument. This top-level results folder will look something like the following, depending on which settings you use:

.. image:: OutputView.png
